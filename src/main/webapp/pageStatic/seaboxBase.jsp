...
%>
		...
		<script src="${localProjectName}/pageJs/base/seabox_public.js?v=${revision}"></script>
		...
		<link href="${localProjectName}/pageCss/seabox-body-common.css?v=${revision}" rel="stylesheet">
		...
		<link href="${localProjectName}/pageCss/seabox-table.css?v=${revision}" rel="stylesheet" media="screen" />
