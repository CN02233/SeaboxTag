...
<script src="${pageContext.request.contextPath}/seabox_js/persongroup/sum/crtSnCdion.js"></script>
                ...
                <table class="title_table" >
                    <tr >
                        <td >
                            ...
                            <div><input type="text" id="screeningNm" name="群组名称" class="form-control nm_text not-null" /></h4></div>


                        </td>
                        <td style="text-align: right;"><h4 >人群数量：<font id="personCnt">0</font></h4></td>
                    </tr>
                </table>
                ...
                <%--<div class="tag_grp">--%>
                    <%--<nav>--%>
                        <%--<ul class="pager">--%>
                            ...
                            <%--</span>--%>
                            <%--</li>--%>
                            <%--<li class="previous" ><span  href="#">Next</span></li>--%>
                            <%--<li class="previous" ><span  href="#">Next</span></li>--%>
                            <%--<li class="previous"><span  href="#">Next</span></li>--%>
                            <%--<li class="previous"><span   href="#">Next</span></li>--%>
                            <%--<li class="previous"><span   href="#">Next</span></li>--%>
                            ...
                            <%--<li class="previous"><span   href="#">Next</span></li>--%>
                            <%--<li class="previous"><span    href="#">Next</span></li>--%>
                            <%--<li class="previous"><a href="#" onclick="removeTagGrp('tag_grp_seq_1')">删除此标签组</a></li>--%>
                        <%--</ul>--%>
                    <%--</nav>--%>
                <%--</div>--%>
                <%--<div class="tag_grp_split_line"></div>--%>
            <%--</div>--%>
            <div id="prompt_msg_body" >
                <div class="tag_grp">
                    <h4 class="prompt_msg">
                        提示：
                    </h4>
                    <h2 class="prompt_msg" >
                        <span class="glyphicon glyphicon-hand-right"></span>请在右侧标签树中勾选标签!
                    </h2>
                    <h2 class="prompt_msg" >
                        <span class="glyphicon glyphicon-hand-right"></span>可将不同的标签进行组合，组合后的标签关系为:
                    </h2>
                    <h2 class="prompt_msg" >
                        <label class="glyphicon glyphicon-send"></label>同一标签组中同一标签类别下标签之间为“或”的关系
                    </h2>
                    <h2 class="prompt_msg" >
                        <label class="glyphicon glyphicon-send"></label>同一标签组中不同标签类别下标签之间为“与”的关系
                    </h2>
                    <h2 class="prompt_msg" >
                        <label class="glyphicon glyphicon-send"></label>标签组之间为“与”的关系
                    </h2>
                    <h2 class="prompt_msg" >
                        <span class="glyphicon glyphicon-hand-right"></span>每个标签组中最少要包含一个标签，否则不允许添加新的标签组。
                    </h2>
                    <h2 class="prompt_msg" >
                        <span class="glyphicon glyphicon-hand-right"></span>页面上方的标签组名称输入框中不允许为空，请输入合法的标签组名称。
                    </h2>
                </div>
            </div>


            <div id="tag_grp_seq_2"  class="allow_edit hidden_init">
                <div class="grp_name">
                    标签组：
                </div>
                <div class="tag_grp">
        ...
        <div class="op_place">
            ...
            <div>
                <nav>
                    <ul class="pager">
                        <li class="add_tag_grp">
                            <button type="button" id="save_btn" class="btn btn-default btn_seabox disabled">暂存</button>

                        </li>

                        <li  class="add_tag_grp">
                            <button type="button" id="submit_btn" class="btn btn-default btn_seabox disabled">提交</button>
